...
namespace UxTheme
{
    ...
    WORD _HitTestRectLeft(LPCRECT prc, int cxMargin, int cyMargin, POINT const& pt, WORD wMiss)
    {
        return (WORD)pt.x <= cxMargin + prc->left ? HTLEFT : wMiss;
    }

    WORD _HitTestRectTop(LPCRECT prc, int cxMargin, int cyMargin, POINT const& pt, WORD wMiss)
    {
        return (WORD)pt.y <= cyMargin + prc->top ? HTTOP : wMiss;
    }

    WORD _HitTestRectRight(LPCRECT prc, int cxMargin, int cyMargin, POINT const& pt, WORD wMiss)
    {
        return (WORD)pt.x >= prc->right - cxMargin ? HTRIGHT : wMiss;
    }

    WORD _HitTestRectBottom(LPCRECT prc, int cxMargin, int cyMargin, POINT const& pt, WORD wMiss)
    {
        return (WORD)pt.y >= prc->bottom - cyMargin ? HTBOTTOM : wMiss;
    }

    WORD _HitTestRectCorner(HITTESTRECTPROC pfnX, HITTESTRECTPROC pfnY,
                            LPCRECT prc, int cxMargin, int cyMargin, int cxMargin2,
    ...
    WORD _HitTestRectTopLeft(RECT const* prc, int cxMargin, int cyMargin,
    ...
    WORD _HitTestRectTopRight(RECT const* prc, int cxMargin, int cyMargin,
                              POINT const& pt, WORD wMiss)
    {
    ...
    WORD _HitTestRectBottomLeft(RECT const* prc, int cxMargin, int cyMargin,
                                POINT const& pt, WORD wMiss)
    {
    ...
    WORD _HitTestRectBottomRight(RECT const* prc, int cxMargin, int cyMargin,
                                 POINT const& pt, WORD wMiss)
    {
    ...
    WORD _HitTestResizingRect(DWORD dwHTFlags, RECT const* prc, POINT const& pt,
    ...
    WORD _HitTestResizingTemplate(DWORD dwHTFlags, HRGN hrgn, POINT const* pt,
