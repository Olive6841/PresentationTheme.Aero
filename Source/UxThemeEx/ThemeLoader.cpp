...
namespace uxtheme
{
    ...
    HRESULT CThemeLoader::AddData(SHORT sTypeNum, BYTE ePrimVal, const void* pData, DWORD dwLen)
    {
    ...
    {
        //return CThemeArray<int,CThemeArrayEqualHelper<int>>::Add(&this->_rgBaseClassIds, &idBaseClass) == 0 ? E_FAIL : S_OK;
    ...
    HRESULT CThemeLoader::LoadTheme(HINSTANCE hInst, wchar_t const* pszThemeName,
