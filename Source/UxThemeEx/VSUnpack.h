...
{
public:
    virtual HRESULT AddIndex(LPCWSTR pszAppName, LPCWSTR pszClassName, int iPartId, int iStateId, int iIndex, int iLen) = 0;
    virtual HRESULT AddData(SHORT sTypeNum, BYTE ePrimVal, const void* pData, DWORD dwLen) = 0;
